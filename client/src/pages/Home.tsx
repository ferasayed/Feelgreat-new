            ...
            <CardContent className="p-8">
              <div className="flex items-center gap-4 mb-6">
                ...
                <div>
                  ...
                  <p className="text-sm text-accent font-medium">Fiber | Metabolism | Wellness</p>
                </div>
              </div>
...
function HowItWorksSection() {
  ...
  const steps = [
    { key: "step1", icon: <Zap className="w-6 h-6" />, color: "bg-primary/10 text-primary" },
    { key: "step2", icon: <Heart className="w-6 h-6" />, color: "bg-accent/15 text-accent" },
    { key: "step3", icon: <TrendingUp className="w-6 h-6" />, color: "bg-primary/10 text-primary" },
  ];
...
function OpportunitySection() {
  ...
  const benefits = [
    { key: "benefit1", icon: <DollarSign className="w-7 h-7" />, color: "bg-primary/10 text-primary" },
    { key: "benefit2", icon: <Clock className="w-7 h-7" />, color: "bg-accent/15 text-accent" },
    { key: "benefit3", icon: <Globe className="w-7 h-7" />, color: "bg-accent/15 text-accent" },
    { key: "benefit4", icon: <GraduationCap className="w-7 h-7" />, color: "bg-primary/10 text-primary" },
  ];
    ...
    <footer className="py-8 bg-foreground text-white/60">
      <div className="container text-center">
        <div className="mb-4 flex justify-center gap-6 text-sm">
          ...
          <a href="https://wa.me/96877020770" target="_blank" rel="noopener noreferrer" className="hover:text-green-400 transition-colors">
            WhatsApp
          </a>
        </div>
...
function WhatsAppFloat() {
  return (
    <a
      ...
      target="_blank"
      rel="noopener noreferrer"
      className="fixed bottom-24 left-6 z-50 bg-green-500 hover:bg-green-600 text-white rounded-full w-14 h-14 flex items-center justify-center shadow-xl hover:scale-110 transition-all duration-200"
      aria-label="WhatsApp"
    >
  ...
  return (
    <div className="fixed bottom-0 left-0 right-0 z-40 bg-white/95 backdrop-blur-sm border-t border-border shadow-2xl py-3 px-4 animate-in slide-in-from-bottom duration-300">
      <div className="container flex items-center justify-between gap-4">
        <p className="text-sm font-medium text-foreground hidden sm:block">{t("hero.subtitle").slice(0, 60)}...</p>
        <a
          href="https://ufeelgreat.com/c/GBP556"
          target="_blank"
          rel="noopener noreferrer"
          className="bg-primary hover:bg-primary/90 text-white font-bold px-6 py-2.5 rounded-full text-sm transition-all hover:scale-105 whitespace-nowrap"
        >
          {t("hero.cta")} →
        </a>
      </div>
