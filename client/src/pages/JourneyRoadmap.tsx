...
export default function JourneyRoadmap() {
  useEffect(() => {
    document.title = "90-Day Health Transformation Roadmap | Feel Great Journey";
  }, []);
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-slate-50 to-white">
      ...
      <section className="py-16 text-center bg-gradient-to-br from-primary/5 via-white to-emerald-50">
        <div className="container max-w-3xl mx-auto">
          <div className="inline-flex items-center gap-2 px-4 py-2 bg-primary/10 rounded-full text-primary text-sm font-medium mb-6">
            ...
            Science-Backed Transformation Protocol
          </div>
          <h1 className="text-4xl md:text-5xl font-bold mb-4">
            Your 90-Day Health<br />Transformation Roadmap
          </h1>
          <p className="text-lg text-muted-foreground max-w-2xl mx-auto">
            A structured, phased approach to reversing metabolic dysfunction, restoring energy, and achieving sustainable weight loss — guided by science and supported by the Feel Great system.
          </p>
        </div>
      </section>
      ...
      <section className="py-16 bg-slate-50">
        <div className="container max-w-4xl mx-auto">
          <h2 className="text-3xl font-bold text-center mb-10">Weekly Focus Guide</h2>
      ...
      <section className="py-16 text-center">
        <div className="container max-w-2xl mx-auto">
          <h2 className="text-3xl font-bold mb-4">Ready to Start Your 90-Day Transformation?</h2>
          <p className="text-muted-foreground mb-8">
            Join thousands who have already transformed their metabolic health with the Feel Great system.
          </p>
