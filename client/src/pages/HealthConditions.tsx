...
const CONDITIONS: ConditionData[] = [
  ...
  // ============================================
  {
    ...
    titleEn: "Your Health Investment: The Best Investment You Can Make in 2024",
    descAr: "الوقاية من الأمراض أرخص بكثير من علاجها. استثمر في صحتك اليوم مع Feel Great واحصل على عائد استثمار يتجاوز 2,500% سنوياً مقارنة بتكاليف علاج الأمراض المزمنة.",
    descEn: "Disease prevention is much cheaper than treatment. Invest in your health today with Feel Great and get ROI exceeding 2,500% annually compared to chronic disease treatment costs.",
    symptomsAr: ["هل تفكر في تكاليف الأدوية مدى الحياة؟", "هل تريد تجنب مستشفيات باهظة الثمن؟", "هل تبحث عن وقاية حقيقية؟"],
    symptomsEn: ["Thinking about lifetime medication costs?", "Want to avoid expensive hospitals?", "Looking for real prevention?"],
    howHelpAr: ["Feel Great استثمار منخفض التكلفة مقابل عائد صحي هائل", "الوقاية من السكري تكلف $99-149/شهر بدلاً من $750-1,150/شهر", "نظام 4-4-12 يقي من الأمراض ويوفر آلاف الدولارات", "منتجات معتمدة علمياً من Unicity"],
    howHelpEn: ["Feel Great: low-cost investment with huge health returns", "Preventing diabetes costs $99-149/month instead of $750-1,150/month", "The 4-4-12 system prevents diseases and saves thousands", "Scientifically approved products from Unicity"],
    factsAr: ["تكلفة السكري في أمريكا: $327 مليار سنوياً", "تكلفة السكري في كندا: $3.8 مليار سنوياً", "استثمار $149/شهر يوفر عليك $9,000+/سنة"],
    factsEn: ["Diabetes cost in America: $327 billion annually", "Diabetes cost in Canada: $3.8 billion annually", "$149/month investment saves you $9,000+/year"],
    relatedCategory: "business-opportunity",
  },
  {
    slug: "cost-of-diabetes-investment",
    titleAr: "تكلفة السكري الحقيقية: ماذا ستدفع إذا لم تستثمر في الوقاية؟",
    titleEn: "The True Cost of Diabetes: What You'll Pay If You Don't Invest in Prevention",
    descAr: "مريض السكري ينفق في المتوسط $9,600 سنوياً على العلاج. مع Feel Great، يمكنك الوقاية من السكري بتكلفة $1,188-1,788 سنوياً. هل تريد أن تحسب الفرق؟",
    descEn: "The average diabetic spends $9,600 annually on treatment. With Feel Great, you can prevent diabetes for $1,188-1,788 annually. Want to calculate the difference?",
    symptomsAr: ["تكاليف الأدوية الشهرية", "زيارات الطبيب المتكررة", "الفحوصات المخبرية", "مضاعفات السكري"],
    symptomsEn: ["Monthly medication costs", "Frequent doctor visits", "Lab tests", "Diabetes complications"],
    howHelpAr: ["Feel Great يمنع السكري من التطور", "توفير $7,812-12,012 سنوياً", "بدون آثار جانبية للأدوية", "تحسين جودة الحياة"],
    howHelpEn: ["Feel Great prevents diabetes from developing", "Save $7,812-12,012 annually", "No medication side effects", "Improved quality of life"],
    factsAr: ["متوسط تكلفة علاج السكري: $9,600/سنة", "تكلفة Feel Great: $1,188-1,788/سنة", "التوفير: $7,812-12,012/سنة"],
    factsEn: ["Average diabetes treatment cost: $9,600/year", "Feel Great cost: $1,188-1,788/year", "Savings: $7,812-12,012/year"],
    relatedCategory: "business-opportunity",
  },
  {
    slug: "unicity-business-investment",
    titleAr: "فرصة عمل Unicity: استثمر في صحتك وافتح مصدر دخلك الخاص",
    titleEn: "Unicity Business Opportunity: Invest in Your Health & Open Your Own Income Stream",
    descAr: "انضم إلى عائلة Unicity واحصل على منتجات Feel Great لنفسك واحصل على فرصة عمل حقيقية مع عمولات تصل إلى 30% ورواتب شهرية تصل إلى $1,000.",
    descEn: "Join the Unicity family and get Feel Great products for yourself plus a real business opportunity with commissions up to 30% and monthly salaries up to $1,000.",
    symptomsAr: ["تريد مصدر دخل إضافي؟", "تبحث عن عمل مرن من المنزل؟", "مهتم بصحة عائلتك؟"],
    symptomsEn: ["Looking for extra income?", "Seeking flexible home-based work?", "Interested in your family's health?"],
    howHelpAr: ["عمولة حتى 30% على المبيعات", "راتب شهري حتى $1,000 (برتبة Director+)", "مكافأة النادي الرئاسي: $10,000-$100,000", "رحلات مكافآت حول العالم"],
    howHelpEn: ["Commission up to 30% on sales", "Monthly salary up to $1,000 (Director+ rank)", "Presidential Club bonus: $10,000-$100,000", "Worldwide reward trips"],
    factsAr: ["خطة التعويضات تدفع حتى الجيل 12", "100 نقطة = Centurion status", "5 أفرع نشطة = رتبة Director"],
    factsEn: ["Compensation plan pays to Generation 12", "100 points = Centurion status", "5 active branches = Director rank"],
    relatedCategory: "business-opportunity",
  },
  {
    slug: "centurion-investment-program",
    titleAr: "برنامج Centurion: استثمارك في القيادة والنجاح",
    titleEn: "Centurion Program: Your Investment in Leadership & Success",
    descAr: "برنامج Centurion يمنحك امتيازات حصرية عند بناء فريقك. كل 100 نقطة سنتوريون تفتح لك أجيال إضافية وعمولات أعلى ومكافآت حصرية.",
    descEn: "The Centurion program gives you exclusive privileges when building your team. Every 100 Centurion points opens additional generations, higher commissions, and exclusive rewards.",
    symptomsAr: ["تريد بناء فريق قيادي؟", "تبني منظمة كبيرة؟", "تستهدف الرتب العليا؟"],
    symptomsEn: ["Want to build a leadership team?", "Building a large organization?", "Targeting top ranks?"],
    howHelpAr: ["30-59 نقطة: +2% على الأجيال 2-4", "60-99 نقطة: +3% على الأجيال 2-4", "100+ نقطة: +5% على الأجيال 2-4", "امتيازات حصرية للسنشريون"],
    howHelpEn: ["30-59 points: +2% on Generations 2-4", "60-99 points: +3% on Generations 2-4", "100+ points: +5% on Generations 2-4", "Exclusive privileges for Centurions"],
    factsAr: ["الحد الأقصى: 3 نقاط سنتوريون/شخص", "30 نقطة سنتوريون = qualification", "100 نقطة = Centurion status"],
    factsEn: ["Maximum: 3 Centurion points/person", "30 Centurion points = qualification", "100 points = Centurion status"],
    relatedCategory: "business-opportunity",
  },
  {
    slug: "compensation-plan-explained",
    titleAr: "خطة تعويضات Unicity: كيف تكسب المال خطوة بخطوة",
    titleEn: "Unicity Compensation Plan: How to Earn Money Step by Step",
    descAr: "فهم خطة التعويضات يمكن أن يغير حياتك المالية. مع Unicity، يمكنك كسب المال من 6 طرق مختلفة: تطوير الأعمال، تطوير الفريق، المؤسسة، الرتبة، الرئاسي، والسنتوريون.",
    descEn: "Understanding the compensation plan can change your financial life. With Unicity, you can earn money in 6 different ways: Business Development, Team Development, Organization, Rank, Presidential, and Centurion.",
    symptomsAr: ["كيف أبدأ في الكسب؟", "ما هي العمولات المتاحة؟", "كيف أصل للراتب الشهري؟"],
    symptomsEn: ["How do I start earning?", "What commissions are available?", "How do I reach monthly salary?"],
    howHelpAr: ["1) تطوير الأعمال: حتى 30%", "2) تطوير الفريق: حتى 14%", "3) المؤسسة: حتى 5% حتى الجيل 12", "4) رتبة شهرية: $150-1,000", "5) النادي الرئاسي: $10,000-100,000", "6) Centurion: +5% إضافي"],
    howHelpEn: ["1) Business Development: up to 30%", "2) Team Development: up to 14%", "3) Organization: up to 5% to Gen 12", "4) Monthly Rank: $150-1,000", "5) Presidential Club: $10,000-100,000", "6) Centurion: +5% extra"],
    factsAr: ["100 PV = Distributor", "1,000 PV = Manager", "5 أفرع = Director", "80,000 PV = Senior ranks"],
    factsEn: ["100 PV = Distributor", "1,000 PV = Manager", "5 branches = Director", "80,000 PV = Senior ranks"],
    relatedCategory: "business-opportunity",
  },
  {
    slug: "prevention-vs-treatment-investment",
    titleAr: "الوقاية خير من العلاج: حاسبة التوفير الاستثمارية",
    titleEn: "Prevention Is Better Than Cure: Investment Savings Calculator",
    descAr: "قارن بين تكلفة الوقاية مع Feel Great وتكلفة علاج الأمراض المزمنة. الأرقام ستذهلك.",
    descEn: "Compare the cost of prevention with Feel Great vs. treating chronic diseases. The numbers will surprise you.",
    symptomsAr: ["ما هو الفرق في التكلفة؟", "كم سأوفر على المدى الطويل؟", "هل الوقاية تستحق؟"],
    symptomsEn: ["What's the cost difference?", "How much will I save long-term?", "Is prevention worth it?"],
    howHelpAr: ["حاسبة التوفير الذكية", "مقارنة واقعية بين الوقاية والعلاج", "ROI حساب العائد على الاستثمار"],
    howHelpEn: ["Smart savings calculator", "Realistic prevention vs treatment comparison", "ROI calculation"],
    factsAr: ["Feel Great: $99-149/شهر", "العلاج التقليدي: $750-1,150/شهر", "التوفير: $7,812-12,012/سنة"],
    factsEn: ["Feel Great: $99-149/month", "Traditional treatment: $750-1,150/month", "Savings: $7,812-12,012/year"],
    relatedCategory: "business-opportunity",
  },
  {
    slug: "passive-income-unicity",
    titleAr: "الدخل السلبي مع Unicity: كيف تبني دخل متكرر بدون سقف",
    titleEn: "Passive Income with Unicity: How to Build Recurring Income with No Ceiling",
    descAr: "مع Unicity، كل عميل جديد يصبح مصدر دخل متكرر مدى الحياة. ابنِ فريقاً مرة واحدة واكسب لسنوات.",
    descEn: "With Unicity, every new customer becomes a recurring income source for life. Build your team once and earn for years.",
    symptomsAr: ["تريد دخلاً سلبياً؟", "تبني شبكة تسويق شبكي؟", "تستهدف الحرية المالية؟"],
    symptomsEn: ["Want passive income?", "Building a network marketing system?", "Targeting financial freedom?"],
    howHelpAr: ["عمولة 25% على عملاء الإحالة مدى الحياة", "بناء الفريق = دخل متكرر", "لا سقف للدخل", "عمل مرة واحدة والدخل يتكرر"],
    howHelpEn: ["25% commission on referral customers for life", "Building team = recurring income", "No income ceiling", "Work once, income repeats"],
    factsAr: ["لا حاجة لإعادة الشراء منك شخصياً", "الفريق يبني دخلك", "Unicity تدفع لعقود"],
    factsEn: ["No need to personally re-purchase", "Team builds your income", "Unicity pays for decades"],
    relatedCategory: "business-opportunity",
  },
  {
    slug: "unicity-roi-calculation",
    titleAr: "حاسبة ROI: كم ستكسب مع Unicity Feel Great؟",
    titleEn: "ROI Calculator: How Much Will You Earn with Unicity Feel Great?",
    descAr: "احسب عائد استثمارك في Feel Great و Unicity. مع الأرقام الصحيحة، القرار يصبح سهلاً.",
    descEn: "Calculate your return on investment in Feel Great and Unicity. With the right numbers, the decision becomes easy.",
    symptomsAr: ["كم سأكسب؟", "ما هو العائد المتوقع؟", "هل يستحق الاستثمار؟"],
    symptomsEn: ["How much will I earn?", "What's the expected return?", "Is the investment worth it?"],
    howHelpAr: ["إدخال: عدد العملاء", "الناتج: العمولة الشهرية", "مثال: 10 عملاء = $250-500/شهر", "50 عميل = $1,250-2,500/شهر"],
    howHelpEn: ["Input: Number of customers", "Output: Monthly commission", "Example: 10 customers = $250-500/month", "50 customers = $1,250-2,500/month"],
    factsAr: ["100 PV = ~$25-35 عمولة", "500 PV = ~$125-175 عمولة", "1,000 PV = ~$250-350 عمولة"],
    factsEn: ["100 PV = ~$25-35 commission", "500 PV = ~$125-175 commission", "1,000 PV = ~$250-350 commission"],
    relatedCategory: "business-opportunity",
  },
];
