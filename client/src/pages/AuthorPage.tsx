...
export default function AuthorPage() {
  ...
  const authorSchema = {
    ...
    "image": "https://feelgreat.us.com/manus-storage/feras-professional.jpg",
    "sameAs": [
      ...
      <header className="bg-gradient-to-br from-emerald-50 to-teal-50 dark:from-emerald-950/30 dark:to-teal-950/30 py-16">
        <div className="container max-w-5xl">
          ...
          <div className="flex flex-col md:flex-row items-start gap-8">
            {/* Author Avatar */}
            <div className="w-32 h-32 rounded-full bg-gradient-to-br from-emerald-500 to-teal-600 flex items-center justify-center text-white text-4xl font-bold shrink-0 shadow-lg">
              FA
            </div>
