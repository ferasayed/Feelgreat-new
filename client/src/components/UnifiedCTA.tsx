...
// Referral link for partners
const PARTNER_REFERRAL_LINK = "https://ufeelgreat.com/c/GBP556";
    ...
    <section className="relative overflow-hidden bg-gradient-to-br from-[#0a1628] via-[#132240] to-[#1a365d] py-16 px-4">
      ...
      <div className="relative max-w-4xl mx-auto text-center">
        ...
        <div className="flex flex-col sm:flex-row items-center justify-center gap-4 mb-8">
          ...
          {/* Partner CTA - Referral Link */}
          <a
            href={PARTNER_REFERRAL_LINK}
            target="_blank"
            rel="noopener noreferrer"
            className="group relative inline-flex items-center gap-3 px-8 py-4 bg-[#c8a951] text-[#0a1628] font-bold text-lg rounded-xl shadow-lg shadow-[#c8a951]/30 hover:bg-[#d4b85c] hover:scale-105 transition-all duration-300"
          >
            {/* Partner Icon */}
